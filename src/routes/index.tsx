      ...
      <div className="relative container-max section-padding">
        <div className="text-center max-w-4xl mx-auto animate-fade-in">
          ...
          <p className="text-xl md:text-2xl mb-8 text-blue-100 leading-relaxed">
            L'avenir se code aujourd'hui.
            Rejoignez la révolution technologique
          </p>
              ...
              <div className="p-6">
                ...
                <div className="bg-primary-50 rounded-lg p-3">
                  <p className="text-primary-800 font-medium text-sm">
                    Présentation sur : {speaker.topic}
                  </p>
                </div>
              </div>
            </div>
    ...
    <section className="section-padding bg-primary-600 text-white">
      <div className="container-max text-center">
        <h2 className="text-4xl font-bold mb-6">
          Prêt à rejoindre TechConf 2026 ?
        </h2>
        <p className="text-xl mb-8 text-blue-100 max-w-2xl mx-auto">
          Ne manquez pas la conférence tech la plus innovante de l'année. 
          Les billets en prévente se vendent rapidement !
        </p>
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <button className="btn-primary bg-white text-primary-600 hover:bg-gray-100 text-lg px-8 py-4">
            Réservez votre billet - XXX €
          </button>
           <button className="btn-primary bg-white text-primary-600 hover:bg-gray-100 text-lg px-8 py-4">
            En savoir plus
          </button>
        ...
        <p className="mt-6 text-blue-200">
          Tarif prévente jusqu'au 1er février | Prix normal : XXX €
        </p>
      </div>
    </section>
  )
