      ...
      <div className="container-max">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Nous sommes reconnaissants envers nos formidables partenaires qui rendent TechConf 2025 possible. 
            Ces leaders de l'industrie soutiennent l'innovation et la croissance de la communauté.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            sponsors.gold.length === 0 && (
              <p className="text-gray-500 text-center col-span-full">
                Aucun partenaire or pour le moment.
              </p>
            )
          }
          
          {sponsors.gold.map((sponsor, index) => (
            <div key={index} className="bg-white rounded-xl shadow-md p-6 border border-gray-200 hover:shadow-lg transition-shadow duration-300 text-center">
              <a 
                href={sponsor.website} 
                className="text-primary-600 hover:text-primary-700 font-semibold text-sm"
                target="_blank" 
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {
            sponsors.silver.length === 0 && (
              <p className="text-gray-500 text-center col-span-full">
                Aucun partenaire argent pour le moment.
              </p>
            )
          }
          {sponsors.silver.map((sponsor, index) => (
            <div key={index} className="bg-white rounded-lg shadow-md p-4 border border-gray-200 hover:shadow-lg transition-shadow duration-300 text-center">
              <a 
                href={sponsor.website} 
  ...
  return (
    <section className="mt-24 bg-gradient-to-br from-primary-50 to-blue-50 rounded-3xl p-8 md:p-12">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Associez-vous à nous pour toucher plus de 200 professionnels de la tech et soutenir la communauté. 
          Plusieurs opportunités de partenariat disponibles pour s'adapter à vos objectifs et budget.
        </p>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
        <h3 className="text-2xl font-bold text-gray-900 mb-4">
          Prêt à devenir partenaire de TechConf 2026 ?
        </h3>
        <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
          Rejoignez les leaders de l'industrie pour soutenir l'innovation et la croissance de la communauté. 
          Contactez notre équipe partenariats pour discuter de packages personnalisés et d'opportunités.
        </p>
